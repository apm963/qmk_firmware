...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_aria(
        ...
        KC_PGDN,   KC_LSFT, KC_Z,         KC_X,    KC_C,    KC_V,    KC_B,    LT(1,KC_NO), KC_N,   KC_M,    KC_COMM,    KC_DOT,  KC_SLSH, KC_RSFT,             KC_UP,
                   KC_LCTL, KC_LGUI,       KC_LALT,     KC_SPC,                           KC_SPC,     KC_RALT,            KC_RGUI,  KC_RCTL,     KC_LEFT,     KC_DOWN,     KC_RGHT),
    [_FN] = LAYOUT_aria(
        KC_MPLY,   KC_GRV,  KC_F1,     KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,         KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,  QK_BOOT,
